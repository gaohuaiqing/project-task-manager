...
async function insertHolidays(): Promise<void> {
  ...
  const holidays: [string, string, boolean][] = [
    ...
    ['2025-09-28', '国庆节调休', true], // 调休上班
    ['2025-10-11', '国庆节调休', true], // 调休上班
    // 中秋节与国庆节合并
